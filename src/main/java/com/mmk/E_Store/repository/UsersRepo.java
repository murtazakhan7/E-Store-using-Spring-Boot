...
public interface UsersRepo extends JpaRepository<Users, Long> {
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Users u SET u.password = :encodedPassword WHERE u.username = :username")
    void updatePasswordByUsername(@Param("username") String username, @Param("encodedPassword") String encodedPassword);
}
